...
from app_movil_escolar_api.views import evento
...
urlpatterns = [
    ...
    #Crear evento
        path('eventos/', evento.EventoViewSet.as_view({'post': 'create'})),
    #Evento Data
        path('lista-eventos/', evento.EventoViewSet.as_view({'get': 'list'})),

    # Necesario para los botones de la tabla
        path('eventos/<int:pk>/', evento.EventoViewSet.as_view({
            'get': 'retrieve', 
            'put': 'update', 
